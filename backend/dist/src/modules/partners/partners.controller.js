...
let PartnersController = class PartnersController {
    ...
    findAll(req) {
        return this.partnersService.findAll(req.user.id);
    }
    create(dto, req) {
        return this.partnersService.create(req.user.id, dto);
    }
    update(id, dto, req) {
        return this.partnersService.update(id, req.user.id, dto);
    }
    remove(id, req) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [partner_dto_1.CreatePartnerDto, Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, partner_dto_1.UpdatePartnerDto, Object]),
    __metadata("design:returntype", void 0)
